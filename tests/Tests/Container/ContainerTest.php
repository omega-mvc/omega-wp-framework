...
use Tests\Container\Support\ATrait;
...
class ContainerTest extends TestCase
{
    ...
    /**
     * Should throw exception if a trait is not instantiable.
     *
     * @return void
     * @throws ReflectionException
     */
    public function testShouldThrowExceptionIfTraitIsNotInstantiable(): void
    {
        $this->expectException(NotInstantiableException::class);

        $this->container->resolve(ATrait::class);
    }

    /**
     * Should throw exception if an enum is not instantiable.
     *
     * @return void
     * @throws ReflectionException
     */
    public function testShouldThrowExceptionIfEnumIsNotInstantiable(): void
    {
        $this->expectException(NotInstantiableException::class);

        $this->container->resolve(AEnum::class);
    }
